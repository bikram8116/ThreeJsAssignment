...
//sets background
scene.background = new THREE.TextureLoader().load("./assets/space.webp");
...
var material = [
  new THREE.MeshBasicMaterial({ map: texLoader.load("./assets/black.png") }),
  new THREE.MeshBasicMaterial({ map: texLoader.load("./assets/black.png") }),
  new THREE.MeshBasicMaterial({ map: texLoader.load("./assets/black.png") }),
  new THREE.MeshBasicMaterial({ map: texLoader.load("./assets/black.png") }),
  new THREE.MeshBasicMaterial({ map: texLoader.load("./assets/final.png") }),
  new THREE.MeshBasicMaterial({ map: texLoader.load("./assets/black.png") }),
];
